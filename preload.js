...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    generatePreviewStrip: (filePath) => ipcRenderer.invoke('generate-preview-strip', filePath),
    ...
    updatePluginFromFolder: (opts) => ipcRenderer.invoke('update-plugin-from-folder', opts),
    scaffoldPlugin: (opts) => ipcRenderer.invoke('scaffold-plugin', opts),
    ...
    dbGetAllHashRatings: () => ipcRenderer.invoke('db-get-all-hash-ratings'),
    dbSetHashRating: (hash, rating) => ipcRenderer.invoke('db-set-hash-rating', hash, rating),
    dbGetAllHashPins: () => ipcRenderer.invoke('db-get-all-hash-pins'),
    dbSetHashPinned: (hash, pinned) => ipcRenderer.invoke('db-set-hash-pinned', hash, pinned),
    dbAddHashTag: (hash, tagId) => ipcRenderer.invoke('db-add-hash-tag', hash, tagId),
    dbRemoveHashTag: (hash, tagId) => ipcRenderer.invoke('db-remove-hash-tag', hash, tagId),
    dbGetHashTags: (hash) => ipcRenderer.invoke('db-get-hash-tags', hash),
    dbGetAllHashTags: () => ipcRenderer.invoke('db-get-all-hash-tags'),
    ...
    autoHashFolder: (filePaths) => ipcRenderer.invoke('auto-hash-folder', filePaths),
