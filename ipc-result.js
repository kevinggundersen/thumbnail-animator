// IPC Result shape helpers — attached to window so renderer.js and
// renderer-features.js can use the same utilities. Loaded as a plain
// <script> before renderer.js in index.html (no module system).
//
// Target shape:
